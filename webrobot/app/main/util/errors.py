...
USER_ALREADY_EXIST = (50001, 'User already exist')
PASSWORD_INCORRECT = (50004, 'Password is not correct')
ADMIN_TOKEN_REQUIRED = (50007, 'Administrator token is required')
TOKEN_ILLEGAL = (50008, 'Token is invalid')
